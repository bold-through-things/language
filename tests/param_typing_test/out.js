...
void (async () => {
    ...
    {    
        let _0x43_test_list = ["a", "b", "c"];
        let _0x44_result = (await _67lang.maybe_await(_0x40_process_list(_0x43_test_list)));
        (await _67lang.maybe_await(console.log(_0x44_result)));
    }
