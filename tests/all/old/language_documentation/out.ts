...
void (async () => {
    'use strict';
    const _0x3f_fuck_bang_ = async function (
        fucks_given: number,
    ) {
        let _0x47_fucks_given = fucks_given;
        console.log("fuck!");
        if (
            (0 <= _0x47_fucks_given)
        ) {
            (await (_0x3f_fuck_bang_((_0x47_fucks_given + (-1)))));
        } else {
        }
    }
    {
    }
    {
        ...
        console.log((0 < 1) && (1 < 2));
        let _0x48_age = 23;
        console.log("my age is", _0x48_age);
        (_0x48_age = 25);
        console.log("actually, i lied. my age is", _0x48_age);
        let _0x49__0 = 0;
        console.log(_0x49__0);
        (_0x49__0 = 2347);
        console.log(_0x49__0);
        ...
        console.log(_0x4d__comma_);
        (_0x4d__comma_ = (_0x4d__comma_ = _0x4d__comma_));
        let _0x4e__2347 = "wow, very helpful.";
        console.log(Array.prototype.join.call(Array.prototype.sort.call(_67lang.string_split(_0x4e__2347, " ")), ", "));
        let _0x4f__67lang_dot_features = {} as Record<string, string>;
        (_0x4f__67lang_dot_features["the get macro"] = "a powerful and flexible method chaining \"syntax sugar\" with clear branching\neliminating the pain of using brackets and having to erase or insert the bracket\nat the beginning and then at the end inherently by being part of 67lang\nwhere indentation rules all.");
        (_0x4f__67lang_dot_features["the flexibility of identifiers"] = "anything can be an identifier. there is only whitespace and non whitespace. this\nfrees programmers to express their ideas in a truly direct and unleashed way.\nif you desire to have a variable named `$`, `,`, `?`, or even `true`, we are\nnot here to stop you. if you are stupid, you will certainly misuse this and obliterate\nyour foot. if you are smart, you will write the most readable code ever written.");
        const _0xb0__67lang_dot_features = _0x4f__67lang_dot_features;
        if (_0xb0__67lang_dot_features["the flexibility of identifiers"] === undefined) { throw new Error("sparse array") }
        let _0x50__we_really_needed_the_generics_yesterday_bang_ = _0xb0__67lang_dot_features["the flexibility of identifiers"];
        console.log(String.prototype.slice.call(_0x50__we_really_needed_the_generics_yesterday_bang_, 0, 67));
        if (
            true
        ) {
            console.log("big");
        ...
        _0x54_where_q_;
        _67lang.string_split(_0x54_where_q_, " ");
        (await (_0x3f_fuck_bang_(6)));
    }
