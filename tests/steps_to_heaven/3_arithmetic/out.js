...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            const _0x2_await__67lang_dot_add_lp_ = await _67lang.add(10, 5)
            const _0x3_await__67lang_dot_log_lp_ = await _67lang.log("Addition:", _0x2_await__67lang_dot_add_lp_)
            _0x3_await__67lang_dot_log_lp_
            const _0x4_await__67lang_dot_add_lp_ = await _67lang.add(2, 3, 4)
            const _0x5_await__67lang_dot_log_lp_ = await _67lang.log("More addition:", _0x4_await__67lang_dot_add_lp_)
            _0x5_await__67lang_dot_log_lp_
            const _0x6_await__67lang_dot_mod_lp_ = await _67lang.mod(17, 5)
            const _0x7_await__67lang_dot_log_lp_ = await _67lang.log("Modulo:", _0x6_await__67lang_dot_mod_lp_)
            _0x7_await__67lang_dot_log_lp_
            const _0x8_await__67lang_dot_add_lp_ = await _67lang.add(1, 2)
            let _0x0_result = _0x8_await__67lang_dot_add_lp_
            _0x0_result
            let _0x1_result = _0x0_result
            const _0x9_await__67lang_dot_log_lp_ = await _67lang.log("Stored result:", _0x1_result)
