...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            let _0x0_fruits = ["apple", "banana", "cherry"]
            _0x0_fruits
            let _0x1_fruits = _0x0_fruits
            const _0xa__0x1_fruits = await _0x1_fruits[0]
            let _0x2_key = _0xa__0x1_fruits
            const _0xb_await__67lang_dot_log_lp_ = await _67lang.log("First fruit:", _0x2_key)
            _0xb_await__67lang_dot_log_lp_
            let _0x3_scores = {}
            _0x3_scores
            let _0x4_scores = _0x3_scores

            _0x4_scores["Alice"] = 95
            const _0xc__0x4_scores = await _0x4_scores["Alice"]
            let _0x5_key = _0xc__0x4_scores
            _0x5_key
            let _0x6_scores = _0x3_scores

            _0x6_scores["Bob"] = 87
            const _0xd__0x6_scores = await _0x6_scores["Bob"]
            let _0x7_key = _0xd__0x6_scores
            _0x7_key
            let _0x8_scores = _0x3_scores
            const _0xe__0x8_scores = await _0x8_scores["Alice"]
            let _0x9_key = _0xe__0x8_scores
            const _0xf_await__67lang_dot_log_lp_ = await _67lang.log("Alice's score:", _0x9_key)
