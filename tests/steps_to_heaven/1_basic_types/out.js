...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            const _0x0_await__67lang_dot_log_lp_ = await _67lang.log("hello world")
            _0x0_await__67lang_dot_log_lp_
            const _0x1_await__67lang_dot_log_lp_ = await _67lang.log(42)
            _0x1_await__67lang_dot_log_lp_
            const _0x2_await__67lang_dot_log_lp_ = await _67lang.log(true)
            _0x2_await__67lang_dot_log_lp_
            const _0x3_await__67lang_dot_log_lp_ = await _67lang.log(false)
