...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            let _0x1_age = 25
            _0x1_age
            let _0x2_active = true
            _0x2_active
            let _0x3_name = _0x0_name
            const _0x6_await__67lang_dot_log_lp_ = await _67lang.log("Name:", _0x3_name)
            _0x6_await__67lang_dot_log_lp_
            let _0x4_age = _0x1_age
            const _0x7_await__67lang_dot_log_lp_ = await _67lang.log("Age:", _0x4_age)
            _0x7_await__67lang_dot_log_lp_
            let _0x5_active = _0x2_active
            const _0x8_await__67lang_dot_log_lp_ = await _67lang.log("Active:", _0x5_active)
