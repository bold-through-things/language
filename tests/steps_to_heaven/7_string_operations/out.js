...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            let _0x0_text = "hello world example"
            _0x0_text
            let _0x1_text = _0x0_text
            const _0xc_split = await String.prototype.split.call(_0x1_text, " ")
            let _0x2_split = _0xc_split
            let _0x3_words = _0x2_split
            _0x3_words
            let _0x4_words = _0x3_words
            const _0xd__0x4_words = await _0x4_words[0]
            let _0x5_key = _0xd__0x4_words
            const _0xe_await__67lang_dot_log_lp_ = await _67lang.log("First word:", _0x5_key)
            _0xe_await__67lang_dot_log_lp_
            let _0x6_words = _0x3_words
            const _0xf__0x6_words = await _0x6_words[2]
            let _0x7_key = _0xf__0x6_words
            const _0x10_await__67lang_dot_log_lp_ = await _67lang.log("Last word:", _0x7_key)
            _0x10_await__67lang_dot_log_lp_
            let _0x8_words = _0x3_words
            const _0x11_join = await Array.prototype.join.call(_0x8_words, "-")
            let _0x9_join = _0x11_join
            let _0xa_joined = _0x9_join
            _0xa_joined
            let _0xb_joined = _0xa_joined
            const _0x12_await__67lang_dot_log_lp_ = await _67lang.log("Joined:", _0xb_joined)
            _0x12_await__67lang_dot_log_lp_
        }
    } 
})();