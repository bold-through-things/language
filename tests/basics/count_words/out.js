...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            const _0xc_iter = _0x3_words[Symbol.iterator]();
            while (true) {
                const { value, done } = _0xc_iter.next();
                if (done) { break; }
                let word = value;
                {
                    const parent_scope = scope
                    {
                        ...
                        let _0x9_word = word
                        const _0xe__0x7_count = await _0x7_count[_0x9_word]
                        let _0x8_key = _0xe__0x7_count
                        const _0xf_await__67lang_dot_add_lp_ = await _67lang.add(1, _0x8_key)
                        _0x4_count[_0x6_word] = _0xf_await__67lang_dot_add_lp_
                        const _0xd__0x4_count = await _0x4_count[_0x6_word]
                        let _0x5_key = _0xd__0x4_count
                        _0x5_key
                    }
                } }
            let _0xa_count = _0x2_count
            const _0x10_await__67lang_dot_log_lp_ = await _67lang.log(_0xa_count)
