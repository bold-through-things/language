...
void (async () => {
        ...
        fucks_given
            ...
            const parent_scope = scope
            {
                ...
                if (_0xd5__0xd2_pipeline_result)
                {
                    ...
                    {
                        const scope = _67lang.scope(parent_scope)
                        const _0xf3_fucks_given = await _0xcf_fucks_given
                        let _0xd9__0xd8_pipeline_result = _0xf3_fucks_given
                        const _0xf2_add = await (_0xd9__0xd8_pipeline_result + -1)
                        let _0xda__0xd7_pipeline_result = _0xf2_add
                        const _0xf1_fuck_bang_ = await _0xcb_fuck_bang_(_0xda__0xd7_pipeline_result)
        ...
        } }
    {
        ...
        const parent_scope = scope
        {
            ...
            const _0xf4_print = await console.log("hello world")
            let _0x2f__0x2e_pipeline_result = _0xf4_print
            _0x2f__0x2e_pipeline_result

            const _0xf5_print = await console.log("\"hello world\" is a fucking stupid non argument.")
            let _0x31__0x30_pipeline_result = _0xf5_print
            _0x31__0x30_pipeline_result


            const _0xf9_concat = await ("new year's " + "eve")
            let _0x36__0x35_pipeline_result = _0xf9_concat
            const _0xf8_eq = await ("new year's eve" === _0x36__0x35_pipeline_result)
            let _0x37__0x34_pipeline_result = _0xf8_eq
            const _0xfb_concat = await ("a very " + "scary " + "error")
            let _0x3a__0x39_pipeline_result = _0xfb_concat
            const _0xfa_eq = await ("a very scary error" === _0x3a__0x39_pipeline_result)
            let _0x3b__0x38_pipeline_result = _0xfa_eq
            const _0xfd_concat = await ("your regex" + " should be stored into the " + "regex" + " variable.")
            let _0x3e__0x3d_pipeline_result = _0xfd_concat
            const _0xfc_eq = await ("your regex should be stored into the regex variable." === _0x3e__0x3d_pipeline_result)
            let _0x3f__0x3c_pipeline_result = _0xfc_eq
            const _0xf7_all = await (_0x37__0x34_pipeline_result && _0x3b__0x38_pipeline_result && _0x3f__0x3c_pipeline_result)
            let _0x40__0x33_pipeline_result = _0xf7_all
            const _0xf6_print = await console.log("this literally cannot be true... yet it is: ", _0x40__0x33_pipeline_result)
            let _0x41__0x32_pipeline_result = _0xf6_print
            _0x41__0x32_pipeline_result

            const _0xfe_print = await console.log("just write the newlines naturally and \nthey will appear in the output, meaning\nwhat you see is what you get.")
            let _0x43__0x42_pipeline_result = _0xfe_print
            _0x43__0x42_pipeline_result


            const _0x100_add = await (2 + 0 + 2)
            let _0x46__0x45_pipeline_result = _0x100_add
            const _0xff_print = await console.log(_0x46__0x45_pipeline_result)
            let _0x47__0x44_pipeline_result = _0xff_print
            _0x47__0x44_pipeline_result
            const _0x102_asc = await (0 < 1 && 1 < 2)
            let _0x4a__0x49_pipeline_result = _0x102_asc
            const _0x101_print = await console.log(_0x4a__0x49_pipeline_result)
            ...
            let _0x4c_age = 23
            _0x4c_age
            const _0x104_age = await _0x4c_age
            let _0x4f__0x4e_pipeline_result = _0x104_age
            const _0x103_print = await console.log("my age is", _0x4f__0x4e_pipeline_result)
            let _0x50__0x4d_pipeline_result = _0x103_print
            _0x50__0x4d_pipeline_result

            const _0x105_age = await (_0x4c_age = 25)
            let _0x52__0x51_pipeline_result = _0x105_age
            _0x52__0x51_pipeline_result
            const _0x107_age = await _0x4c_age
            let _0x55__0x54_pipeline_result = _0x107_age
            const _0x106_print = await console.log("actually, i lied. my age is", _0x55__0x54_pipeline_result)
            ...
            const _0x109__0 = await _0x57__0
            let _0x5a__0x59_pipeline_result = _0x109__0
            const _0x108_print = await console.log(_0x5a__0x59_pipeline_result)
            let _0x5b__0x58_pipeline_result = _0x108_print
            _0x5b__0x58_pipeline_result

            const _0x10a__0 = await (_0x57__0 = 2347)
            let _0x5d__0x5c_pipeline_result = _0x10a__0
            _0x5d__0x5c_pipeline_result
            const _0x10c__0 = await _0x57__0
            let _0x60__0x5f_pipeline_result = _0x10c__0
            const _0x10b_print = await console.log(_0x60__0x5f_pipeline_result)
            ...
            _0x65__comma_
            const _0x10e__comma_ = await _0x65__comma_
            let _0x68__0x67_pipeline_result = _0x10e__comma_
            const _0x10d_print = await console.log(_0x68__0x67_pipeline_result)
            let _0x69__0x66_pipeline_result = _0x10d_print
            _0x69__0x66_pipeline_result


            const _0x111__comma_ = await _0x65__comma_
            let _0x6d__0x6c_pipeline_result = _0x111__comma_
            const _0x110__comma_ = await (_0x65__comma_ = _0x6d__0x6c_pipeline_result)
            let _0x6e__0x6b_pipeline_result = _0x110__comma_
            const _0x10f__comma_ = await (_0x65__comma_ = _0x6e__0x6b_pipeline_result)
            let _0x6f__0x6a_pipeline_result = _0x10f__comma_
            _0x6f__0x6a_pipeline_result

            let _0x70__2347 = "wow, very helpful."
            _0x70__2347
            const _0x113__2347 = await _0x70__2347
            const _0x112_split = await String.prototype.split.call(_0x113__2347, " ")
            let _0x72__0x71_pipeline_result = _0x112_split
            _0x72__0x71_pipeline_result
            const _0x115__0x71_pipeline_result = await _0x72__0x71_pipeline_result
            const _0x114_sort = await Array.prototype.sort.call(_0x115__0x71_pipeline_result)
            let _0x74__0x73_pipeline_result = _0x114_sort
            _0x74__0x73_pipeline_result
            const _0x117__0x73_pipeline_result = await _0x74__0x73_pipeline_result
            const _0x116_join = await Array.prototype.join.call(_0x117__0x73_pipeline_result, ", ")
            let _0x76__0x75_pipeline_result = _0x116_join
            _0x76__0x75_pipeline_result
            const _0x119__0x75_pipeline_result = await _0x76__0x75_pipeline_result
            const _0x118_print = await console.log(_0x119__0x75_pipeline_result)
            ...
            const _0x121__we_really_needed_the_generics_yesterday_bang_ = await _0x80__we_really_needed_the_generics_yesterday_bang_
            const _0x120_slice = await String.prototype.slice.call(_0x121__we_really_needed_the_generics_yesterday_bang_, 0, 67)
            let _0x82__0x81_pipeline_result = _0x120_slice
            _0x82__0x81_pipeline_result
            const _0x123__0x81_pipeline_result = await _0x82__0x81_pipeline_result
            const _0x122_print = await console.log(_0x123__0x81_pipeline_result)
            ...
            if (true)
            {
                ...
                {
                    const scope = _67lang.scope(parent_scope)
                    const _0x124_print = await console.log("big")
            ...
            if (false)
            {
                ...
                {
                    const scope = _67lang.scope(parent_scope)
                    const _0x125_print = await console.log("big")
                ...
                {
                    const scope = _67lang.scope(parent_scope)
                    const _0x126_print = await console.log("my disappointment is immeasurable and my day is ruined.")
...

            {
                const parent_scope = scope
                {
                    ...
                    const _0x127_i_hate_this_trash_bang_ = await _0x8b_i_hate_this_trash_bang_
                    ...
                    while(true) {
                        const _0x129__0x8c_for_angy__index = await _0x8e__0x8c_for_angy__index
                        let _0x94__0x93_pipeline_result = _0x129__0x8c_for_angy__index
                        const _0x12b__0x8d_for_angy__list = await _0x91__0x8d_for_angy__list
                        const _0x12a_length = await (_0x12b__0x8d_for_angy__list.length)
                        let _0x96__0x95_pipeline_result = _0x12a_length
                        const _0x128_asc = await (_0x94__0x93_pipeline_result < _0x96__0x95_pipeline_result)
                        ...
                        if (!_0x97__0x92_pipeline_result) { break; }
                        {
                            ...
                            {
                                const scope = _67lang.scope(parent_scope)
                                const _0x12d__0x8d_for_angy__list = await _0x91__0x8d_for_angy__list
                                const _0x12e__0x8c_for_angy__index = await _0x8e__0x8c_for_angy__index
                                let _0x9a__0x99_pipeline_result = _0x12e__0x8c_for_angy__index
                                const _0x12c__hash_ = await _0x12d__0x8d_for_angy__list[_0x9a__0x99_pipeline_result]
                                let _0x9b__0x98_pipeline_result = _0x12c__hash_
                                let _0x9c_angy = _0x9b__0x98_pipeline_result
                                _0x9c_angy
                                const _0x131__0x8c_for_angy__index = await _0x8e__0x8c_for_angy__index
                                const _0x130_add = await (_0x131__0x8c_for_angy__index + 1)
                                let _0x9f__0x9e_pipeline_result = _0x130_add
                                const _0x12f__0x8c_for_angy__index = await (_0x8e__0x8c_for_angy__index = _0x9f__0x9e_pipeline_result)
                                let _0xa0__0x9d_pipeline_result = _0x12f__0x8c_for_angy__index
                                _0xa0__0x9d_pipeline_result
                                const _0x134_angy = await _0x9c_angy
                                let _0xa4__0xa3_pipeline_result = _0x134_angy
                                const _0x133_concat = await (_0xa4__0xa3_pipeline_result + "!!!")
                                let _0xa5__0xa2_pipeline_result = _0x133_concat
                                const _0x132_print = await console.log(_0xa5__0xa2_pipeline_result)
            ...
            while(true) {
                const _0x135_does_a_decent_programming_language_exist_q_ = await _0xa7_does_a_decent_programming_language_exist_q_
                ...
                if (!_0xa9__0xa8_pipeline_result) { break; }
                {
                    ...
                    {
                        const scope = _67lang.scope(parent_scope)
                        const _0x136_print = await console.log("code for quality software")
            ...
            const _0x138_all = await (true && true && false)
            let _0xae__0xad_pipeline_result = _0x138_all
            const _0x137_print = await console.log("false: ", _0xae__0xad_pipeline_result)
            let _0xaf__0xac_pipeline_result = _0x137_print
            _0xaf__0xac_pipeline_result
            const _0x13a_any = await (true || false || false)
            let _0xb2__0xb1_pipeline_result = _0x13a_any
            const _0x139_print = await console.log("true: ", _0xb2__0xb1_pipeline_result)
            let _0xb3__0xb0_pipeline_result = _0x139_print
            _0xb3__0xb0_pipeline_result
            const _0x13c_none = await !(false || false || false)
            let _0xb6__0xb5_pipeline_result = _0x13c_none
            const _0x13b_print = await console.log("true: ", _0xb6__0xb5_pipeline_result)
            let _0xb7__0xb4_pipeline_result = _0x13b_print
            _0xb7__0xb4_pipeline_result
            const _0x13e_add = await (1 + 1 + 1 + 1 + 1 + 1)
            let _0xba__0xb9_pipeline_result = _0x13e_add
            const _0x13d_print = await console.log("6: ", _0xba__0xb9_pipeline_result)
            ...
            const _0x141_where_q_ = await _0xbd_where_q_
            let _0xc3__0xc2_pipeline_result = _0x141_where_q_
            _0xc3__0xc2_pipeline_result

            const _0x145_where_q_ = await _0xbd_where_q_
            const _0x144_split = await String.prototype.split.call(_0x145_where_q_, " ")
            let _0xc7__0xc6_pipeline_result = _0x144_split
            _0xc7__0xc6_pipeline_result



            const _0x148_fuck_bang_ = await _0xcb_fuck_bang_(6)
