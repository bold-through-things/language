...
export class Emission_macro_context implements Macro_context {
  ...
  apply() {
    ...
    default_logger.indent(this, "codegen", `emitting \`${this.node.content}\``, () => {
      default_logger.log(this, "codegen", `for macro ${macroName}`);
      ...
      if (this.compiler.error_tracker.has_errors) {
        default_logger.log(this, "codegen", "skipping malformed node due to existing compile errors");
        return;
      }
