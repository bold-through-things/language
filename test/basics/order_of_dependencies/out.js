...
void (async () => {
    ...
    const scope = globalThis;
    {
        const parent_scope = scope
        {
            ...
            const _0x5 = await indentifire.call_or_set(scope, 'modules', {})
            _0x5
            /*lines call=False index=False args=["'lines'"]*/
            const _0x6_lines = await indentifire.get_or_call(scope, 'lines')
            ...
            while (true) {
                ...
                }
                {
                    const parent_scope = scope
                    {
                        ...
                        const _0x8 = await indentifire.call_or_set(scope, 'module', {})
                        _0x8
                        scope.kv = indentifire.store()
                        /*line call=False index=False args=["'line'"]*/
                        const _0x9_line = await indentifire.get_or_call(scope, 'line')
                        /*split call=True index=False args=["'split'", '":"', '2']*/
                        const _0xa_split = await indentifire.call_or_set(_0x9_line, 'split', ":", 2)
                        const _0xb = await indentifire.call_or_set(scope, 'kv', _0xa_split)
                        _0xb
                        /*module call=False index=False args=["'module'"]*/
                        const _0xc_module = await indentifire.get_or_call(scope, 'module')
                        /*kv call=False index=False args=["'kv'"]*/
                        const _0xd_kv = await indentifire.get_or_call(scope, 'kv')
                        /*0 call=False index=False args=["'0'"]*/
                        const _0xe_0 = await indentifire.get_or_call(_0xd_kv, '0')
                        /*trim call=False index=False args=["'trim'"]*/
                        const _0xf_trim = await indentifire.get_or_call(_0xe_0, 'trim')
                        /*id call=True index=False args=["'id'", '_0xf_trim']*/
                        const _0x10_id = await indentifire.call_or_set(_0xc_module, 'id', _0xf_trim)
                        _0x10_id
                        /*module call=False index=False args=["'module'"]*/
                        const _0x11_module = await indentifire.get_or_call(scope, 'module')
                        /*kv call=False index=False args=["'kv'"]*/
                        const _0x12_kv = await indentifire.get_or_call(scope, 'kv')
                        /*1 call=False index=False args=["'1'"]*/
                        const _0x13_1 = await indentifire.get_or_call(_0x12_kv, '1')
                        /*trim call=False index=False args=["'trim'"]*/
                        const _0x14_trim = await indentifire.get_or_call(_0x13_1, 'trim')
                        /*split call=True index=False args=["'split'", '/\\s+/']*/
                        const _0x15_split = await indentifire.call_or_set(_0x14_trim, 'split', /\s+/)
                        /*deps call=True index=False args=["'deps'", '_0x15_split']*/
                        const _0x16_deps = await indentifire.call_or_set(_0x11_module, 'deps', _0x15_split)
                        _0x16_deps

                        /*kv call=False index=False args=["'kv'"]*/
                        const _0x17_kv = await indentifire.get_or_call(scope, 'kv')
                        /*1 call=False index=False args=["'1'"]*/
                        const _0x18_1 = await indentifire.get_or_call(_0x17_kv, '1')
                        /*trim call=False index=False args=["'trim'"]*/
                        const _0x19_trim = await indentifire.get_or_call(_0x18_1, 'trim')
                        ...
                        {{
                                const parent_scope = scope
                                {
                                    const scope = indentifire.scope(parent_scope)
                                    /*module call=False index=False args=["'module'"]*/
                                    const _0x1b_module = await indentifire.get_or_call(scope, 'module')
                                    /*deps call=True index=False args=["'deps'", '[]']*/
                                    const _0x1c_deps = await indentifire.call_or_set(_0x1b_module, 'deps', [])
                                    _0x1c_deps
                                }
                            } }
                        ...
                        const _0x1e_id = await indentifire.get_or_call(_0x1d_module, 'id')
                        /*modules call=False index=False args=["'modules'"]*/
                        const _0x1f_modules = await indentifire.get_or_call(scope, 'modules')
                        /*module call=False index=False args=["'module'"]*/
                        const _0x20_module = await indentifire.get_or_call(scope, 'module')
                        /*id call=True index=True args=['_0x1e_id', '_0x20_module']*/
                        const _0x21_id = await indentifire.call_or_set(_0x1f_modules, _0x1e_id, _0x20_module)
                        _0x21_id
                    }
                } }
            ...
            const _0x22 = await indentifire.call_or_set(scope, 'build_order', [])
            _0x22
            scope.dep_loops = indentifire.store()
            const _0x23 = await indentifire.call_or_set(scope, 'dep_loops', [])
            _0x23
            scope.visit = async function (
                ...
                chain
                    ...
                    const parent_scope = scope
                    {
                        ...
                        scope.chain = chain
                        /*module call=False index=False args=["'module'"]*/
                        const _0x24_module = await indentifire.get_or_call(scope, 'module')
                        /*visited call=False index=False args=["'visited'"]*/
                        const _0x25_visited = await indentifire.get_or_call(_0x24_module, 'visited')
                        if (_0x25_visited)
                        {{
                                const parent_scope = scope
                                {
                        ...
                        const _0x27_visited = await indentifire.call_or_set(_0x26_module, 'visited', true)
                        _0x27_visited

                        scope.next_chain = indentifire.store()
                        /*chain call=False index=False args=["'chain'"]*/
                        const _0x28_chain = await indentifire.get_or_call(scope, 'chain')
                        /*slice call=False index=False args=["'slice'"]*/
                        const _0x29_slice = await indentifire.get_or_call(_0x28_chain, 'slice')
                        const _0x2a = await indentifire.call_or_set(scope, 'next_chain', _0x29_slice)
                        _0x2a
                        /*next_chain call=False index=False args=["'next_chain'"]*/
                        const _0x2b_next_chain = await indentifire.get_or_call(scope, 'next_chain')
                        /*module call=False index=False args=["'module'"]*/
                        const _0x2c_module = await indentifire.get_or_call(scope, 'module')
                        /*id call=False index=False args=["'id'"]*/
                        const _0x2d_id = await indentifire.get_or_call(_0x2c_module, 'id')
                        /*push call=True index=False args=["'push'", '_0x2d_id']*/
                        const _0x2e_push = await indentifire.call_or_set(_0x2b_next_chain, 'push', _0x2d_id)
                        _0x2e_push
                        /*module call=False index=False args=["'module'"]*/
                        const _0x2f_module = await indentifire.get_or_call(scope, 'module')
                        /*deps call=False index=False args=["'deps'"]*/
                        const _0x30_deps = await indentifire.get_or_call(_0x2f_module, 'deps')
                        ...
                        while (true) {
                            ...
                            }
                            {
                                const parent_scope = scope
                                {
                                    const scope = indentifire.scope(parent_scope)
                                    /*next_chain call=False index=False args=["'next_chain'"]*/
                                    const _0x32_next_chain = await indentifire.get_or_call(scope, 'next_chain')
                                    /*dep_id call=False index=False args=["'dep_id'"]*/
                                    const _0x33_dep_id = await indentifire.get_or_call(scope, 'dep_id')
                                    ...
                                    {{
                                            const parent_scope = scope
                                            {
                                                ...
                                                const _0x35 = await indentifire.call_or_set(scope, 'dep_loop', [])
                                                _0x35
                                                /*dep_loop call=False index=False args=["'dep_loop'"]*/
                                                const _0x36_dep_loop = await indentifire.get_or_call(scope, 'dep_loop')
                                                /*dep_id call=False index=False args=["'dep_id'"]*/
                                                const _0x37_dep_id = await indentifire.get_or_call(scope, 'dep_id')
                                                /*push call=True index=False args=["'push'", '_0x37_dep_id']*/
                                                const _0x38_push = await indentifire.call_or_set(_0x36_dep_loop, 'push', _0x37_dep_id)
                                                _0x38_push
                                                /*next_chain call=False index=False args=["'next_chain'"]*/
                                                const _0x39_next_chain = await indentifire.get_or_call(scope, 'next_chain')
                                                /*slice call=False index=False args=["'slice'"]*/
                                                const _0x3a_slice = await indentifire.get_or_call(_0x39_next_chain, 'slice')
                                                /*reverse call=False index=False args=["'reverse'"]*/
                                                const _0x3b_reverse = await indentifire.get_or_call(_0x3a_slice, 'reverse')
                                                ...
                                                while (true) {
                                                    ...
                                                    }
                                                    {
                                                        const parent_scope = scope
                                                        {
                                                            const scope = indentifire.scope(parent_scope)
                                                            /*dep_loop call=False index=False args=["'dep_loop'"]*/
                                                            const _0x3d_dep_loop = await indentifire.get_or_call(scope, 'dep_loop')
                                                            /*chain_dep_id call=False index=False args=["'chain_dep_id'"]*/
                                                            const _0x3e_chain_dep_id = await indentifire.get_or_call(scope, 'chain_dep_id')
                                                            /*push call=True index=False args=["'push'", '_0x3e_chain_dep_id']*/
                                                            const _0x3f_push = await indentifire.call_or_set(_0x3d_dep_loop, 'push', _0x3e_chain_dep_id)
                                                            _0x3f_push
                                                            /*chain_dep_id call=False index=False args=["'chain_dep_id'"]*/
                                                            const _0x40_chain_dep_id = await indentifire.get_or_call(scope, 'chain_dep_id')
                                                            /*dep_id call=False index=False args=["'dep_id'"]*/
                                                            const _0x41_dep_id = await indentifire.get_or_call(scope, 'dep_id')
                                                ...
                                                /*reverse call=False index=False args=["'reverse'"]*/
                                                const _0x44_reverse = await indentifire.get_or_call(_0x43_dep_loop, 'reverse')
                                                _0x44_reverse
                                                /*dep_loops call=False index=False args=["'dep_loops'"]*/
                                                const _0x45_dep_loops = await indentifire.get_or_call(scope, 'dep_loops')
                                                /*dep_loop call=False index=False args=["'dep_loop'"]*/
                                                const _0x46_dep_loop = await indentifire.get_or_call(scope, 'dep_loop')
                                                /*join call=True index=False args=["'join'", '" → "']*/
                                                const _0x47_join = await indentifire.call_or_set(_0x46_dep_loop, 'join', " → ")
                                                /*push call=True index=False args=["'push'", '_0x47_join']*/
                                                const _0x48_push = await indentifire.call_or_set(_0x45_dep_loops, 'push', _0x47_join)
                                                _0x48_push
                                            }
                                        } }
                                        ...
                                        const parent_scope = scope
                                        {
                                            ...
                                            const _0x4d_dep = await indentifire.get_or_call(scope, 'dep')
                                            /*visited call=False index=False args=["'visited'"]*/
                                            const _0x4e_visited = await indentifire.get_or_call(_0x4d_dep, 'visited')
                                            ...
                                            {{
                                                    const parent_scope = scope
                                                    {
                                                        const scope = indentifire.scope(parent_scope)
                                                        /*dep call=False index=False args=["'dep'"]*/
                                                        const _0x50_dep = await indentifire.get_or_call(scope, 'dep')
                                                        /*next_chain call=False index=False args=["'next_chain'"]*/
                                                        const _0x51_next_chain = await indentifire.get_or_call(scope, 'next_chain')
                                                        /*visit call=True index=False args=["'visit'", '_0x50_dep', '_0x51_next_chain']*/
                                                        const _0x52_visit = await indentifire.call_or_set(scope, 'visit', _0x50_dep, _0x51_next_chain)
                                                        _0x52_visit
                                                    }
                                                } }
                        ...
                        /*module call=False index=False args=["'module'"]*/
                        const _0x54_module = await indentifire.get_or_call(scope, 'module')
                        /*id call=False index=False args=["'id'"]*/
                        const _0x55_id = await indentifire.get_or_call(_0x54_module, 'id')
                        /*push call=True index=False args=["'push'", '_0x55_id']*/
                        const _0x56_push = await indentifire.call_or_set(_0x53_build_order, 'push', _0x55_id)
                        _0x56_push
                    }
                } }
            ...
            while (true) {
                ...
                }
                {
                    const parent_scope = scope
                    {
                        const scope = indentifire.scope(parent_scope)
                        /*module call=False index=False args=["'module'"]*/
                        const _0x5a_module = await indentifire.get_or_call(scope, 'module')
                        /*visit call=True index=False args=["'visit'", '_0x5a_module', '[]']*/
                        const _0x5b_visit = await indentifire.call_or_set(scope, 'visit', _0x5a_module, [])
                        _0x5b_visit
                    }
                } }
            ...
            const _0x5d_length = await indentifire.get_or_call(_0x5c_dep_loops, 'length')
            ...
            {{
                    const parent_scope = scope
                    {
                        const scope = indentifire.scope(parent_scope)
                        /*dep_loops call=False index=False args=["'dep_loops'"]*/
                        const _0x5f_dep_loops = await indentifire.get_or_call(scope, 'dep_loops')
                        /*join call=True index=False args=["'join'", '"\\n"']*/
                        const _0x60_join = await indentifire.call_or_set(_0x5f_dep_loops, 'join', "\n")
                ...
                const parent_scope = scope
                {
                    const scope = indentifire.scope(parent_scope)
                    /*build_order call=False index=False args=["'build_order'"]*/
                    const _0x63_build_order = await indentifire.get_or_call(scope, 'build_order')
                    /*join call=True index=False args=["'join'", '"\\n"']*/
                    const _0x64_join = await indentifire.call_or_set(_0x63_build_order, 'join', "\n")
